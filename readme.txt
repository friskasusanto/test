...
- php artisan migrate
- php artisan db:seed
- I use my mailtrap account for testing sending email to company while add new employe, need some adjustment in .env file for make it can send to real email/gmail if website will online
